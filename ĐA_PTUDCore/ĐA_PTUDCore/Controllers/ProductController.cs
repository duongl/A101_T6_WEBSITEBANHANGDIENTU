...
namespace ShopBanLaptop2.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult suaThongTinLaptop(Laptop lap)
        {
            if(ModelState.IsValid)
            {
                ViewBag.Success = LaptopConnect.Instance.EditLaptop(lap.Id, lap.Name,lap.Quantity, lap.IdCategory, lap.Price, lap.ProductCompany, lap.monitor, lap.CPU, lap.RAM, lap.Image, lap.GPU, lap.HardDisk);
