...
namespace BLL_DAL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="QLCuaHangDienTu")]
	public partial class QLCuaHangDienTuDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Deletetransport(transport instance);
		...
		public QLCuaHangDienTuDataContext() : 
				base(global::BLL_DAL.Properties.Settings.Default.QLCuaHangDienTuConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public QLCuaHangDienTuDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLCuaHangDienTuDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLCuaHangDienTuDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLCuaHangDienTuDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OntypeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="account_bill1", Storage="_bills1", ThisKey="id", OtherKey="idAccount")]
    ...
    partial void OndatepayChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="account_bill1", Storage="_account1", ThisKey="idAccount", OtherKey="id", IsForeignKey=true)]
